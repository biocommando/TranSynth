/*
  ...
  My modifications denoted with (++ modification ++)
*/
...
//==============================================================================
class VAStateVariableFilter : public FilterBase {
public:
    ...
    */
    ...
    /** Used for setting the resonance amount. This is then converted to a Q
        ...
        Range: (0-1)
    */
    // modified to match the base class (++
    ...
    */
    ...
    // (++
    void setSamplerate(int sr) { setSampleRate(sr); }
    void reset() {}
